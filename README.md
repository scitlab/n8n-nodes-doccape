...
You need an api key to use this node. You can get one by registering at [Doccape](TODO).
...
With the `textLabels` configuration you can set the types of PII that are detected. For a list of supported types, see the [Doccape Api documentation](TODO).
